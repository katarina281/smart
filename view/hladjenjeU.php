...
include("../model/config.php");
 $idHladjenje=$_REQUEST['idHladjenje'];

 
 $sql3= "SELECT g.temperatura,g.ukljuceno,u.idUser,u.username,g.idHladjenje FROM hladjenje g JOIN user u ON g.idUser=u.idUser WHERE u.username='".$_SESSION['username']."'";
 ...
 <section id="contact">
    <div class="container wow fadeInUp">
      ...
      <div>
            ...
            $update="update hladjenje set temperatura='".$temperatura."', ukljuceno='".$ukljuceno."' where idHladjenje='".$idHladjenje."'";
            mysqli_query($link, $update) or die(mysqli_error($link));
            $status = "Vidite izmenu. </br></br>
            <a href='hladjenje.php'>Izmena</a>";
            echo '<p>'.$status.'</p>';
            }else {
            ?>
            <div>
            ...
            <input name="idHladjenje" type="hidden" value="<?php echo $row3['idHladjenje'];?>" />
