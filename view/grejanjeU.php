...
include("../model/config.php");
 $idGrejanje=$_REQUEST['idGrejanje'];

 
 $sql3= "SELECT g.temperatura,g.ukljuceno,u.idUser,u.username,g.idGrejanje FROM grejanje g JOIN user u ON g.idUser=u.idUser WHERE u.username='".$_SESSION['username']."'";
...
<body>
 ...
 <section id="contact">
    <div class="container wow fadeInUp">
      ...
      <div>
            <h2 style="text-align: center;">Podesite grejanje u Vasoj kuci</h2>
            <br>
            <img src="img/grejanje.jpg" style="margin-left: 340px;">
            ...
            $update="update grejanje set temperatura='".$temperatura."', ukljuceno='".$ukljuceno."' where idGrejanje='".$idGrejanje."'";
            mysqli_query($link, $update) or die(mysqli_error($link));
            $status = "Vidite izmenu. </br></br>
            <a href='grejanje.php'>Izmena</a>";
            echo '<p>'.$status.'</p>';
            }else {
            ?>
            <div>
            ...
            <input name="idGrejanje" type="hidden" value="<?php echo $row3['idGrejanje'];?>" />
            <label>Temperatura</label>
            <p><input  type="text" name="temperatura" 
            required value="<?php echo $row3['temperatura'];?>" /></p>
            <label>Ukljuci/Isklju</label>
